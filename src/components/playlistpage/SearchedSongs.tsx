              ...
              >
                ...
                <td>
                  <div className="flex gap-4">
                    <img src={song.cover} className="h-12 w-12 rounded-lg" alt={song.title} />
                    <div className="flex flex-col items-start justify-center">
                      <h3 className="font-md w-[60vw] text-start font-bold text-white">{song.title}</h3>
                      <h4 className="text-sm text-white">{song.artist.fullName}</h4>
                    </div>
                  </div>
                </td>
                ...
                <td>
                  {inPlaylist ? (
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="h-6 w-6 text-green-600" viewBox="0 0 16 16">
