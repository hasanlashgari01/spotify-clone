        ...
        <div className="ring-opacity-5 absolute right-0 z-20 mt-2 w-40 origin-top-right rounded-md bg-[#101721] py-1 shadow-lg ring-1 ring-black focus:outline-none">
          {OPTIONS.map((opt) => {
            ...
            return (
              <button
                key={opt.key}
                className={`flex w-full cursor-pointer items-center justify-between px-3 py-2 text-sm ${active ? 'bg-[#00c754] text-white' : 'text-zinc-200 hover:bg-[#00c75373] hover:text-white'}`}
