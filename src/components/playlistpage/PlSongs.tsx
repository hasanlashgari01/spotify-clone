              ...
              >
                <td className="relative w-5 text-center">
                  ...
                  <div
                    ...
                    className={`playBTN absolute top-1/2 left-1/2 h-5 w-5 -translate-x-1/2 flex justify-center items-center -translate-y-1/2 transform bg-green-600 p-1 rounded-full  ${
