    ...
    <div className="relative z-50 flex h-[220px] flex-col items-start justify-end overflow-hidden rounded-b-2xl bg-cover bg-center sm:h-[300px] md:h-[340px] lg:h-[390px]">
      ...
      <div className="flex w-[100vw] items-start justify-between">
        ...
        <div className="relative top-[30%] mr-22 flex h-fit flex-col items-center justify-center gap-5 rounded-2xl p-3 transition-all sm:top-[30%] sm:mr-20 sm:rounded-3xl sm:p-5 md:top-[20%] md:mr-15 md:p-10 lg:top-[10%] lg:mr-30 lg:p-13">
          ...
          <h1 className="md:text-md w-[163px] rounded-3xl border border-[rgba(0,150,255,0.3)] bg-[rgba(0,20,50,0.4)] px-6 py-3 text-xs font-semibold tracking-wide text-white shadow-[0_0_20px_rgba(0,120,255,0.6)] backdrop-blur-md transition-all duration-300 ease-out sm:w-fit sm:text-sm lg:text-lg">
